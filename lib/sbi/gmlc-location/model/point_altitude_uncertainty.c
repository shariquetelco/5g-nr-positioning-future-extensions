...
point_altitude_uncertainty_t *point_altitude_uncertainty_create(
	...
	int v_confidence) {
	point_altitude_uncertainty_t *point_altitude_uncertainty_local_var =
		malloc(sizeof(point_altitude_uncertainty_t));
	...
	point_altitude_uncertainty_local_var->uncertainty_ellipse =
		uncertainty_ellipse;
	point_altitude_uncertainty_local_var->uncertainty_altitude =
...
cJSON *point_altitude_uncertainty_convertToJSON(
	...
	if(point_altitude_uncertainty == NULL) {
		printf(
			"point_altitude_uncertainty_convertToJSON() failed [PointAltitudeUncertainty]");
		return NULL;
	}

	item = cJSON_CreateObject();
	if(point_altitude_uncertainty->shape == supported_gad_shapes_NULL) {
		printf(
			"point_altitude_uncertainty_convertToJSON() failed [shape]");
		return NULL;
	}
	...
	if(!point_altitude_uncertainty->point) {
		printf(
			"point_altitude_uncertainty_convertToJSON() failed [point]");
		return NULL;
	}
	...
	{
		printf(
			"point_altitude_uncertainty_convertToJSON() failed [altitude]");
		goto end;
	}

	if(!point_altitude_uncertainty->uncertainty_ellipse) {
		printf(
			"point_altitude_uncertainty_convertToJSON() failed [uncertainty_ellipse]");
		return NULL;
	}
	...
	{
		printf(
			"point_altitude_uncertainty_convertToJSON() failed [uncertainty_altitude]");
		goto end;
	}
	...
	{
		printf(
			"point_altitude_uncertainty_convertToJSON() failed [confidence]");
		goto end;
	}
	...
	if(point_altitude_uncertainty->is_v_confidence) {
		...
		{
			printf(
				"point_altitude_uncertainty_convertToJSON() failed [v_confidence]");
			goto end;
		}
	}
...
point_altitude_uncertainty_t *point_altitude_uncertainty_parseFromJSON(
	...
	shape = cJSON_GetObjectItemCaseSensitive(point_altitude_uncertaintyJSON,
	                                         "shape");
	if(!shape) {
		printf(
			"point_altitude_uncertainty_parseFromJSON() failed [shape]");
		goto end;
	}
	...
	point = cJSON_GetObjectItemCaseSensitive(point_altitude_uncertaintyJSON,
	                                         "point");
	if(!point) {
		printf(
			"point_altitude_uncertainty_parseFromJSON() failed [point]");
		goto end;
	}
	...
	altitude = cJSON_GetObjectItemCaseSensitive(
		point_altitude_uncertaintyJSON, "altitude");
	if(!altitude) {
		printf(
			"point_altitude_uncertainty_parseFromJSON() failed [altitude]");
		goto end;
	}
	...
	uncertainty_ellipse = cJSON_GetObjectItemCaseSensitive(
		point_altitude_uncertaintyJSON, "uncertaintyEllipse");
	if(!uncertainty_ellipse) {
		printf(
			"point_altitude_uncertainty_parseFromJSON() failed [uncertainty_ellipse]");
		goto end;
	}
	...
	uncertainty_altitude = cJSON_GetObjectItemCaseSensitive(
		point_altitude_uncertaintyJSON, "uncertaintyAltitude");
	if(!uncertainty_altitude) {
		printf(
			"point_altitude_uncertainty_parseFromJSON() failed [uncertainty_altitude]");
		goto end;
	}
	...
	confidence = cJSON_GetObjectItemCaseSensitive(
		point_altitude_uncertaintyJSON, "confidence");
	if(!confidence) {
		printf(
			"point_altitude_uncertainty_parseFromJSON() failed [confidence]");
		goto end;
	}
	...
	v_confidence = cJSON_GetObjectItemCaseSensitive(
		point_altitude_uncertaintyJSON, "vConfidence");
	if(v_confidence) {
		if(!cJSON_IsNumber(v_confidence)) {
			printf(
				"point_altitude_uncertainty_parseFromJSON() failed [v_confidence]");
			goto end;
		}
	}

	point_altitude_uncertainty_local_var =
		point_altitude_uncertainty_create(
			shapeVariable,
			point_local_nonprim,
...
point_altitude_uncertainty_t *point_altitude_uncertainty_copy(
	...
	item = point_altitude_uncertainty_convertToJSON(src);
	if(!item) {
		printf("point_altitude_uncertainty_convertToJSON() failed");
		return NULL;
	}
	...
	point_altitude_uncertainty_free(dst);
	dst = point_altitude_uncertainty_parseFromJSON(item);
	cJSON_Delete(item);
