	...
	if(include_optional) {
		positioning_method_and_usage =
			positioning_method_and_usage_create(
				ngmlc_location_positioning_method_and_usage__CELLID,
				ngmlc_location_positioning_method_and_usage__UE_BASED,
				ngmlc_location_positioning_method_and_usage__UNSUCCESS,
				16
				);
	} else {
		positioning_method_and_usage =
