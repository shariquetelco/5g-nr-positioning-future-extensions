	...
	if(include_optional) {
		gnss_positioning_method_and_usage =
			gnss_positioning_method_and_usage_create(
				ngmlc_location_gnss_positioning_method_and_usage__UE_BASED,
				ngmlc_location_gnss_positioning_method_and_usage__GPS,
				ngmlc_location_gnss_positioning_method_and_usage__UNSUCCESS
				);
	} else {
		gnss_positioning_method_and_usage =
			gnss_positioning_method_and_usage_create(
