...
#include <stdio.h>
#include <ctype.h>
#include "N1N2SubscriptionsCollectionForIndividualUEContextsCollectionAPI.h"
	...
	ue_n1_n2_info_subscription_create_data_t *ue_n1_n2_info_subscription_create_data)
{
	...
	long sizeOfPath = strlen(
		"/ue-contexts/{ueContextId}/n1-n2-messages/subscriptions") + 1;
	...
	// Body Param
	cJSON *localVarSingleItemJSON_ue_n1_n2_info_subscription_create_data =
		NULL;
	if(ue_n1_n2_info_subscription_create_data != NULL) {
		// string
		localVarSingleItemJSON_ue_n1_n2_info_subscription_create_data =
	...
	cJSON *
	        N1N2SubscriptionsCollectionForIndividualUEContextsCollectionAPIlocalVarJSON
	        = cJSON_Parse(apiClient->dataReceived);
	ue_n1_n2_info_subscription_created_data_t *elementToReturn =
	...
	if(localVarSingleItemJSON_ue_n1_n2_info_subscription_create_data) {
		cJSON_Delete(
			localVarSingleItemJSON_ue_n1_n2_info_subscription_create_data);
		localVarSingleItemJSON_ue_n1_n2_info_subscription_create_data =
			NULL;
