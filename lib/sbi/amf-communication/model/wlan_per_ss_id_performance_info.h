...
#ifndef _wlan_per_ss_id_performance_info_H_
#define _wlan_per_ss_id_performance_info_H_
...
typedef struct wlan_per_ss_id_performance_info_s
...
#endif /* _wlan_per_ss_id_performance_info_H_ */
