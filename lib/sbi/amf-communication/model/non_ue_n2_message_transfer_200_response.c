...
non_ue_n2_message_transfer_200_response_create(
	...
	non_ue_n2_message_transfer_200_response_t *
	        non_ue_n2_message_transfer_200_response_local_var =
		malloc(sizeof(non_ue_n2_message_transfer_200_response_t));

	non_ue_n2_message_transfer_200_response_local_var->json_data =
		json_data;
	non_ue_n2_message_transfer_200_response_local_var->
	binary_data_n2_information1 = binary_data_n2_information1;
	non_ue_n2_message_transfer_200_response_local_var->
	binary_data_n2_information2 = binary_data_n2_information2;
	non_ue_n2_message_transfer_200_response_local_var->
	binary_data_n2_information3 = binary_data_n2_information3;
	non_ue_n2_message_transfer_200_response_local_var->
	binary_data_n2_information4 = binary_data_n2_information4;
	non_ue_n2_message_transfer_200_response_local_var->
	binary_data_n2_information5 = binary_data_n2_information5;
	non_ue_n2_message_transfer_200_response_local_var->
	binary_data_n2_information6 = binary_data_n2_information6;
	non_ue_n2_message_transfer_200_response_local_var->
	binary_data_n2_information7 = binary_data_n2_information7;
	non_ue_n2_message_transfer_200_response_local_var->
	binary_data_n2_information8 = binary_data_n2_information8;
	non_ue_n2_message_transfer_200_response_local_var->
	binary_data_n2_information9 = binary_data_n2_information9;
	non_ue_n2_message_transfer_200_response_local_var->
	binary_data_n2_information10 = binary_data_n2_information10;
	...
	non_ue_n2_message_transfer_200_response_t *non_ue_n2_message_transfer_200_response)
{
	...
	if(non_ue_n2_message_transfer_200_response->json_data) {
		n2_information_transfer_rsp_data_free(
			non_ue_n2_message_transfer_200_response->json_data);
	...
	{
		free(
			non_ue_n2_message_transfer_200_response->binary_data_n2_information1->data);
		non_ue_n2_message_transfer_200_response->
		binary_data_n2_information1 = NULL;
	}
	if(non_ue_n2_message_transfer_200_response->binary_data_n2_information2)
	{
		free(
			non_ue_n2_message_transfer_200_response->binary_data_n2_information2->data);
		non_ue_n2_message_transfer_200_response->
		binary_data_n2_information2 = NULL;
	}
	if(non_ue_n2_message_transfer_200_response->binary_data_n2_information3)
	{
		free(
			non_ue_n2_message_transfer_200_response->binary_data_n2_information3->data);
		non_ue_n2_message_transfer_200_response->
		binary_data_n2_information3 = NULL;
	}
	if(non_ue_n2_message_transfer_200_response->binary_data_n2_information4)
	{
		free(
			non_ue_n2_message_transfer_200_response->binary_data_n2_information4->data);
		non_ue_n2_message_transfer_200_response->
		binary_data_n2_information4 = NULL;
	}
	if(non_ue_n2_message_transfer_200_response->binary_data_n2_information5)
	{
		free(
			non_ue_n2_message_transfer_200_response->binary_data_n2_information5->data);
		non_ue_n2_message_transfer_200_response->
		binary_data_n2_information5 = NULL;
	}
	if(non_ue_n2_message_transfer_200_response->binary_data_n2_information6)
	{
		free(
			non_ue_n2_message_transfer_200_response->binary_data_n2_information6->data);
		non_ue_n2_message_transfer_200_response->
		binary_data_n2_information6 = NULL;
	}
	if(non_ue_n2_message_transfer_200_response->binary_data_n2_information7)
	{
		free(
			non_ue_n2_message_transfer_200_response->binary_data_n2_information7->data);
		non_ue_n2_message_transfer_200_response->
		binary_data_n2_information7 = NULL;
	}
	if(non_ue_n2_message_transfer_200_response->binary_data_n2_information8)
	{
		free(
			non_ue_n2_message_transfer_200_response->binary_data_n2_information8->data);
		non_ue_n2_message_transfer_200_response->
		binary_data_n2_information8 = NULL;
	}
	if(non_ue_n2_message_transfer_200_response->binary_data_n2_information9)
	{
		free(
			non_ue_n2_message_transfer_200_response->binary_data_n2_information9->data);
		non_ue_n2_message_transfer_200_response->
		binary_data_n2_information9 = NULL;
	}
	if(non_ue_n2_message_transfer_200_response->binary_data_n2_information10)
	{
		free(
			non_ue_n2_message_transfer_200_response->binary_data_n2_information10->data);
		non_ue_n2_message_transfer_200_response->
		binary_data_n2_information10 = NULL;
	}
	free(non_ue_n2_message_transfer_200_response);
}
	...
	non_ue_n2_message_transfer_200_response_t *non_ue_n2_message_transfer_200_response)
{
	...
	if(non_ue_n2_message_transfer_200_response == NULL) {
		printf(
			"non_ue_n2_message_transfer_200_response_convertToJSON() failed [NonUeN2MessageTransfer_200_response]");
		return NULL;
	}
	...
	if(non_ue_n2_message_transfer_200_response->json_data) {
		...
		if(json_data_local_JSON == NULL) {
			printf(
				"non_ue_n2_message_transfer_200_response_convertToJSON() failed [json_data]");
			goto end;
		}
	...
	if(non_ue_n2_message_transfer_200_response->binary_data_n2_information1)
	{
		char *encoded_str_binary_data_n2_information1 = base64encode(
			non_ue_n2_message_transfer_200_response->binary_data_n2_information1->data,
			non_ue_n2_message_transfer_200_response->binary_data_n2_information1->len);
		if(cJSON_AddStringToObject(item, "binaryDataN2Information1",
		                           encoded_str_binary_data_n2_information1)
		   == NULL)
		{
			printf(
				"non_ue_n2_message_transfer_200_response_convertToJSON() failed [binary_data_n2_information1]");
			goto end;
		}
	...
	if(non_ue_n2_message_transfer_200_response->binary_data_n2_information2)
	{
		char *encoded_str_binary_data_n2_information2 = base64encode(
			non_ue_n2_message_transfer_200_response->binary_data_n2_information2->data,
			non_ue_n2_message_transfer_200_response->binary_data_n2_information2->len);
		if(cJSON_AddStringToObject(item, "binaryDataN2Information2",
		                           encoded_str_binary_data_n2_information2)
		   == NULL)
		{
			printf(
				"non_ue_n2_message_transfer_200_response_convertToJSON() failed [binary_data_n2_information2]");
			goto end;
		}
	...
	if(non_ue_n2_message_transfer_200_response->binary_data_n2_information3)
	{
		char *encoded_str_binary_data_n2_information3 = base64encode(
			non_ue_n2_message_transfer_200_response->binary_data_n2_information3->data,
			non_ue_n2_message_transfer_200_response->binary_data_n2_information3->len);
		if(cJSON_AddStringToObject(item, "binaryDataN2Information3",
		                           encoded_str_binary_data_n2_information3)
		   == NULL)
		{
			printf(
				"non_ue_n2_message_transfer_200_response_convertToJSON() failed [binary_data_n2_information3]");
			goto end;
		}
	...
	if(non_ue_n2_message_transfer_200_response->binary_data_n2_information4)
	{
		char *encoded_str_binary_data_n2_information4 = base64encode(
			non_ue_n2_message_transfer_200_response->binary_data_n2_information4->data,
			non_ue_n2_message_transfer_200_response->binary_data_n2_information4->len);
		if(cJSON_AddStringToObject(item, "binaryDataN2Information4",
		                           encoded_str_binary_data_n2_information4)
		   == NULL)
		{
			printf(
				"non_ue_n2_message_transfer_200_response_convertToJSON() failed [binary_data_n2_information4]");
			goto end;
		}
	...
	if(non_ue_n2_message_transfer_200_response->binary_data_n2_information5)
	{
		char *encoded_str_binary_data_n2_information5 = base64encode(
			non_ue_n2_message_transfer_200_response->binary_data_n2_information5->data,
			non_ue_n2_message_transfer_200_response->binary_data_n2_information5->len);
		if(cJSON_AddStringToObject(item, "binaryDataN2Information5",
		                           encoded_str_binary_data_n2_information5)
		   == NULL)
		{
			printf(
				"non_ue_n2_message_transfer_200_response_convertToJSON() failed [binary_data_n2_information5]");
			goto end;
		}
	...
	if(non_ue_n2_message_transfer_200_response->binary_data_n2_information6)
	{
		char *encoded_str_binary_data_n2_information6 = base64encode(
			non_ue_n2_message_transfer_200_response->binary_data_n2_information6->data,
			non_ue_n2_message_transfer_200_response->binary_data_n2_information6->len);
		if(cJSON_AddStringToObject(item, "binaryDataN2Information6",
		                           encoded_str_binary_data_n2_information6)
		   == NULL)
		{
			printf(
				"non_ue_n2_message_transfer_200_response_convertToJSON() failed [binary_data_n2_information6]");
			goto end;
		}
	...
	if(non_ue_n2_message_transfer_200_response->binary_data_n2_information7)
	{
		char *encoded_str_binary_data_n2_information7 = base64encode(
			non_ue_n2_message_transfer_200_response->binary_data_n2_information7->data,
			non_ue_n2_message_transfer_200_response->binary_data_n2_information7->len);
		if(cJSON_AddStringToObject(item, "binaryDataN2Information7",
		                           encoded_str_binary_data_n2_information7)
		   == NULL)
		{
			printf(
				"non_ue_n2_message_transfer_200_response_convertToJSON() failed [binary_data_n2_information7]");
			goto end;
		}
	...
	if(non_ue_n2_message_transfer_200_response->binary_data_n2_information8)
	{
		char *encoded_str_binary_data_n2_information8 = base64encode(
			non_ue_n2_message_transfer_200_response->binary_data_n2_information8->data,
			non_ue_n2_message_transfer_200_response->binary_data_n2_information8->len);
		if(cJSON_AddStringToObject(item, "binaryDataN2Information8",
		                           encoded_str_binary_data_n2_information8)
		   == NULL)
		{
			printf(
				"non_ue_n2_message_transfer_200_response_convertToJSON() failed [binary_data_n2_information8]");
			goto end;
		}
	...
	if(non_ue_n2_message_transfer_200_response->binary_data_n2_information9)
	{
		char *encoded_str_binary_data_n2_information9 = base64encode(
			non_ue_n2_message_transfer_200_response->binary_data_n2_information9->data,
			non_ue_n2_message_transfer_200_response->binary_data_n2_information9->len);
		if(cJSON_AddStringToObject(item, "binaryDataN2Information9",
		                           encoded_str_binary_data_n2_information9)
		   == NULL)
		{
			printf(
				"non_ue_n2_message_transfer_200_response_convertToJSON() failed [binary_data_n2_information9]");
			goto end;
		}
	...
	if(non_ue_n2_message_transfer_200_response->binary_data_n2_information10)
	{
		char *encoded_str_binary_data_n2_information10 = base64encode(
			non_ue_n2_message_transfer_200_response->binary_data_n2_information10->data,
			non_ue_n2_message_transfer_200_response->binary_data_n2_information10->len);
		if(cJSON_AddStringToObject(item, "binaryDataN2Information10",
		                           encoded_str_binary_data_n2_information10)
		   == NULL)
		{
			printf(
				"non_ue_n2_message_transfer_200_response_convertToJSON() failed [binary_data_n2_information10]");
			goto end;
		}
...
non_ue_n2_message_transfer_200_response_parseFromJSON(
	...
	non_ue_n2_message_transfer_200_response_t *
	        non_ue_n2_message_transfer_200_response_local_var = NULL;
	lnode_t *node = NULL;
	cJSON *json_data = NULL;
	n2_information_transfer_rsp_data_t *json_data_local_nonprim = NULL;
	...
	json_data = cJSON_GetObjectItemCaseSensitive(
		non_ue_n2_message_transfer_200_responseJSON, "jsonData");
	if(json_data) {
		json_data_local_nonprim =
			n2_information_transfer_rsp_data_parseFromJSON(json_data);
		if(!json_data_local_nonprim) {
			printf(
				"n2_information_transfer_rsp_data_parseFromJSON failed [json_data]");
			goto end;
		}
	}

	binary_data_n2_information1 = cJSON_GetObjectItemCaseSensitive(
		non_ue_n2_message_transfer_200_responseJSON,
	...
	if(binary_data_n2_information1) {
		...
		if(!cJSON_IsString(binary_data_n2_information1)) {
			printf(
				"non_ue_n2_message_transfer_200_response_parseFromJSON() failed [binary_data_n2_information1]");
			goto end;
		}
	...
	if(binary_data_n2_information2) {
		...
		if(!cJSON_IsString(binary_data_n2_information2)) {
			printf(
				"non_ue_n2_message_transfer_200_response_parseFromJSON() failed [binary_data_n2_information2]");
			goto end;
		}
	...
	if(binary_data_n2_information3) {
		...
		if(!cJSON_IsString(binary_data_n2_information3)) {
			printf(
				"non_ue_n2_message_transfer_200_response_parseFromJSON() failed [binary_data_n2_information3]");
			goto end;
		}
	...
	if(binary_data_n2_information4) {
		...
		if(!cJSON_IsString(binary_data_n2_information4)) {
			printf(
				"non_ue_n2_message_transfer_200_response_parseFromJSON() failed [binary_data_n2_information4]");
			goto end;
		}
	...
	if(binary_data_n2_information5) {
		...
		if(!cJSON_IsString(binary_data_n2_information5)) {
			printf(
				"non_ue_n2_message_transfer_200_response_parseFromJSON() failed [binary_data_n2_information5]");
			goto end;
		}
	...
	if(binary_data_n2_information6) {
		...
		if(!cJSON_IsString(binary_data_n2_information6)) {
			printf(
				"non_ue_n2_message_transfer_200_response_parseFromJSON() failed [binary_data_n2_information6]");
			goto end;
		}
	...
	if(binary_data_n2_information7) {
		...
		if(!cJSON_IsString(binary_data_n2_information7)) {
			printf(
				"non_ue_n2_message_transfer_200_response_parseFromJSON() failed [binary_data_n2_information7]");
			goto end;
		}
	...
	if(binary_data_n2_information8) {
		...
		if(!cJSON_IsString(binary_data_n2_information8)) {
			printf(
				"non_ue_n2_message_transfer_200_response_parseFromJSON() failed [binary_data_n2_information8]");
			goto end;
		}
	...
	if(binary_data_n2_information9) {
		...
		if(!cJSON_IsString(binary_data_n2_information9)) {
			printf(
				"non_ue_n2_message_transfer_200_response_parseFromJSON() failed [binary_data_n2_information9]");
			goto end;
		}
	...
	if(binary_data_n2_information10) {
		...
		if(!cJSON_IsString(binary_data_n2_information10)) {
			printf(
				"non_ue_n2_message_transfer_200_response_parseFromJSON() failed [binary_data_n2_information10]");
			goto end;
		}
	...
	if(json_data_local_nonprim) {
		n2_information_transfer_rsp_data_free(json_data_local_nonprim);
...
non_ue_n2_message_transfer_200_response_copy(
	...
	item = non_ue_n2_message_transfer_200_response_convertToJSON(src);
	if(!item) {
		printf(
			"non_ue_n2_message_transfer_200_response_convertToJSON() failed");
		return NULL;
	}
	...
	non_ue_n2_message_transfer_200_response_free(dst);
	dst = non_ue_n2_message_transfer_200_response_parseFromJSON(item);
	cJSON_Delete(item);
