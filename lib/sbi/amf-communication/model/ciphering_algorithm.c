...
char *ciphering_algorithm_ToString(ciphering_algorithm_e ciphering_algorithm) {
	const char *ciphering_algorithmArray[] =
	{ "NULL", "NEA0", "NEA1", "NEA2", "NEA3" };
	size_t sizeofArray = sizeof(ciphering_algorithmArray) /
	                     sizeof(ciphering_algorithmArray[0]);
...
ciphering_algorithm_e ciphering_algorithm_FromString(char *ciphering_algorithm)
{
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(ciphering_algorithm,
		          ciphering_algorithmArray[stringToReturn]) == 0) {
