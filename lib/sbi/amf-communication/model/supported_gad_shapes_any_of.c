...
char *supported_gad_shapes_any_of_ToString(
	...
	const char *supported_gad_shapes_any_ofArray[] =
	...
	size_t sizeofArray = sizeof(supported_gad_shapes_any_ofArray) /
	                     sizeof(supported_gad_shapes_any_ofArray[0]);
	if(supported_gad_shapes_any_of < sizeofArray) {
		return (char *) supported_gad_shapes_any_ofArray[
...
supported_gad_shapes_any_of_e supported_gad_shapes_any_of_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(supported_gad_shapes_any_of,
		          supported_gad_shapes_any_ofArray[stringToReturn]) ==
		   0) {
