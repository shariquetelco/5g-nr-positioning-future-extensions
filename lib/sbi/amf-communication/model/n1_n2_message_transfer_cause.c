...
char *n1_n2_message_transfer_cause_ToString(
	...
	const char *n1_n2_message_transfer_causeArray[] =
	{ "NULL", "ATTEMPTING_TO_REACH_UE", "N1_N2_TRANSFER_INITIATED",
	  "WAITING_FOR_ASYNCHRONOUS_TRANSFER", "UE_NOT_RESPONDING",
	  ...
	  "REJECTION_DUE_TO_PAGING_RESTRICTION", "AN_NOT_RESPONDING",
	  "FAILURE_CAUSE_UNSPECIFIED" };
	size_t sizeofArray = sizeof(n1_n2_message_transfer_causeArray) /
	                     sizeof(n1_n2_message_transfer_causeArray[0]);
	if(n1_n2_message_transfer_cause < sizeofArray) {
		return (char *) n1_n2_message_transfer_causeArray[
...
n1_n2_message_transfer_cause_e n1_n2_message_transfer_cause_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(n1_n2_message_transfer_cause,
		          n1_n2_message_transfer_causeArray[stringToReturn]) ==
		   0) {
