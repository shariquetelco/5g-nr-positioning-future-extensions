...
char *n2_info_notify_reason_ToString(
	...
	const char *n2_info_notify_reasonArray[] =
	{ "NULL", "HANDOVER_COMPLETED" };
	size_t sizeofArray = sizeof(n2_info_notify_reasonArray) /
	                     sizeof(n2_info_notify_reasonArray[0]);
...
n2_info_notify_reason_e n2_info_notify_reason_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(n2_info_notify_reason,
		          n2_info_notify_reasonArray[stringToReturn]) == 0) {
