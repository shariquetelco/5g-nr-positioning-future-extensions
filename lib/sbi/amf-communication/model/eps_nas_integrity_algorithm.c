...
char *eps_nas_integrity_algorithm_ToString(
	...
	const char *eps_nas_integrity_algorithmArray[] =
	{ "NULL", "EIA0", "EIA1", "EIA2", "EIA3" };
	size_t sizeofArray = sizeof(eps_nas_integrity_algorithmArray) /
	                     sizeof(eps_nas_integrity_algorithmArray[0]);
	if(eps_nas_integrity_algorithm < sizeofArray) {
		return (char *) eps_nas_integrity_algorithmArray[
...
eps_nas_integrity_algorithm_e eps_nas_integrity_algorithm_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(eps_nas_integrity_algorithm,
		          eps_nas_integrity_algorithmArray[stringToReturn]) ==
		   0) {
