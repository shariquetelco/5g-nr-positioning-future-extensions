...
ext_amf_event_subscription_t *ext_amf_event_subscription_create(
	...
	ext_amf_event_subscription_t *ext_amf_event_subscription_local_var =
		malloc(sizeof(ext_amf_event_subscription_t));

	ext_amf_event_subscription_local_var->event_list = event_list;
	ext_amf_event_subscription_local_var->event_notify_uri =
		event_notify_uri;
	ext_amf_event_subscription_local_var->notify_correlation_id =
		notify_correlation_id;
	ext_amf_event_subscription_local_var->nf_id = nf_id;
	ext_amf_event_subscription_local_var->subs_change_notify_uri =
		subs_change_notify_uri;
	ext_amf_event_subscription_local_var->subs_change_notify_correlation_id
	...
	ext_amf_event_subscription_local_var->exclude_supi_list =
		exclude_supi_list;
	ext_amf_event_subscription_local_var->exclude_gpsi_list =
		exclude_gpsi_list;
	ext_amf_event_subscription_local_var->include_supi_list =
		include_supi_list;
	ext_amf_event_subscription_local_var->include_gpsi_list =
		include_gpsi_list;
	...
	ext_amf_event_subscription_local_var->is_term_notify_ind =
		is_term_notify_ind;
...
void ext_amf_event_subscription_free(
	...
	if(ext_amf_event_subscription->supi) {
		free(ext_amf_event_subscription->supi);
		ext_amf_event_subscription->supi = NULL;
	}
	if(ext_amf_event_subscription->group_id) {
		free(ext_amf_event_subscription->group_id);
		ext_amf_event_subscription->group_id = NULL;
	}
	if(ext_amf_event_subscription->exclude_supi_list) {
		list_for_each(ext_amf_event_subscription->exclude_supi_list,
		              node) {
			free(node->data);
		}
		list_free(ext_amf_event_subscription->exclude_supi_list);
		ext_amf_event_subscription->exclude_supi_list = NULL;
	}
	if(ext_amf_event_subscription->exclude_gpsi_list) {
		list_for_each(ext_amf_event_subscription->exclude_gpsi_list,
		              node) {
			free(node->data);
		}
		list_free(ext_amf_event_subscription->exclude_gpsi_list);
		ext_amf_event_subscription->exclude_gpsi_list = NULL;
	}
	if(ext_amf_event_subscription->include_supi_list) {
		list_for_each(ext_amf_event_subscription->include_supi_list,
		              node) {
			free(node->data);
		}
		list_free(ext_amf_event_subscription->include_supi_list);
		ext_amf_event_subscription->include_supi_list = NULL;
	}
	if(ext_amf_event_subscription->include_gpsi_list) {
		list_for_each(ext_amf_event_subscription->include_gpsi_list,
		              node) {
			free(node->data);
		}
		list_free(ext_amf_event_subscription->include_gpsi_list);
		ext_amf_event_subscription->include_gpsi_list = NULL;
	}
	if(ext_amf_event_subscription->gpsi) {
		free(ext_amf_event_subscription->gpsi);
		ext_amf_event_subscription->gpsi = NULL;
	}
	if(ext_amf_event_subscription->pei) {
		free(ext_amf_event_subscription->pei);
		ext_amf_event_subscription->pei = NULL;
	}
	if(ext_amf_event_subscription->options) {
		amf_event_mode_free(ext_amf_event_subscription->options);
		ext_amf_event_subscription->options = NULL;
	}
	if(ext_amf_event_subscription->source_nf_type) {
		nf_type_free(ext_amf_event_subscription->source_nf_type);
		ext_amf_event_subscription->source_nf_type = NULL;
	}
	if(ext_amf_event_subscription->binding_info) {
		list_for_each(ext_amf_event_subscription->binding_info, node) {
			free(node->data);
		}
		list_free(ext_amf_event_subscription->binding_info);
		ext_amf_event_subscription->binding_info = NULL;
	}
	if(ext_amf_event_subscription->subscribing_nf_type) {
		nf_type_free(ext_amf_event_subscription->subscribing_nf_type);
		ext_amf_event_subscription->subscribing_nf_type = NULL;
	}
	if(ext_amf_event_subscription->nf_consumer_info) {
		list_for_each(ext_amf_event_subscription->nf_consumer_info,
		              node) {
			free(node->data);
		}
		list_free(ext_amf_event_subscription->nf_consumer_info);
		ext_amf_event_subscription->nf_consumer_info = NULL;
	}
	if(ext_amf_event_subscription->aoi_state_list) {
		list_for_each(ext_amf_event_subscription->aoi_state_list,
		              node) {
...
cJSON *ext_amf_event_subscription_convertToJSON(
	...
	if(ext_amf_event_subscription == NULL) {
		printf(
			"ext_amf_event_subscription_convertToJSON() failed [ExtAmfEventSubscription]");
		return NULL;
	}
	...
	if(!ext_amf_event_subscription->event_list) {
		printf(
			"ext_amf_event_subscription_convertToJSON() failed [event_list]");
		return NULL;
	}
	...
	if(!ext_amf_event_subscription->event_notify_uri) {
		printf(
			"ext_amf_event_subscription_convertToJSON() failed [event_notify_uri]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "eventNotifyUri",
	                           ext_amf_event_subscription->event_notify_uri)
	   == NULL)
	{
		printf(
			"ext_amf_event_subscription_convertToJSON() failed [event_notify_uri]");
	...
	if(!ext_amf_event_subscription->notify_correlation_id) {
		printf(
			"ext_amf_event_subscription_convertToJSON() failed [notify_correlation_id]");
		return NULL;
	}
	...
	if(!ext_amf_event_subscription->nf_id) {
		printf(
			"ext_amf_event_subscription_convertToJSON() failed [nf_id]");
		return NULL;
	}
	...
	if(ext_amf_event_subscription->subs_change_notify_uri) {
		...
		{
			printf(
				"ext_amf_event_subscription_convertToJSON() failed [subs_change_notify_uri]");
			goto end;
		}
	}
	...
	if(ext_amf_event_subscription->subs_change_notify_correlation_id) {
		...
		{
			printf(
				"ext_amf_event_subscription_convertToJSON() failed [subs_change_notify_correlation_id]");
			goto end;
		}
	}
	...
	if(ext_amf_event_subscription->supi) {
		if(cJSON_AddStringToObject(item, "supi",
		                           ext_amf_event_subscription->supi) ==
		   NULL)
		{
			printf(
				"ext_amf_event_subscription_convertToJSON() failed [supi]");
			goto end;
		}
	}
	...
	if(ext_amf_event_subscription->group_id) {
		if(cJSON_AddStringToObject(item, "groupId",
		                           ext_amf_event_subscription->group_id)
		   == NULL)
		{
			printf(
				"ext_amf_event_subscription_convertToJSON() failed [group_id]");
			goto end;
		}
	}
	...
	if(ext_amf_event_subscription->exclude_supi_list) {
		...
		if(exclude_supi_listList == NULL) {
			printf(
				"ext_amf_event_subscription_convertToJSON() failed [exclude_supi_list]");
			goto end;
		}
		list_for_each(ext_amf_event_subscription->exclude_supi_list,
		              node) {
	...
	if(ext_amf_event_subscription->exclude_gpsi_list) {
		...
		if(exclude_gpsi_listList == NULL) {
			printf(
				"ext_amf_event_subscription_convertToJSON() failed [exclude_gpsi_list]");
			goto end;
		}
		list_for_each(ext_amf_event_subscription->exclude_gpsi_list,
		              node) {
	...
	if(ext_amf_event_subscription->include_supi_list) {
		...
		if(include_supi_listList == NULL) {
			printf(
				"ext_amf_event_subscription_convertToJSON() failed [include_supi_list]");
			goto end;
		}
		list_for_each(ext_amf_event_subscription->include_supi_list,
		              node) {
	...
	if(ext_amf_event_subscription->include_gpsi_list) {
		...
		if(include_gpsi_listList == NULL) {
			printf(
				"ext_amf_event_subscription_convertToJSON() failed [include_gpsi_list]");
			goto end;
		}
		list_for_each(ext_amf_event_subscription->include_gpsi_list,
		              node) {
	...
	if(ext_amf_event_subscription->gpsi) {
		if(cJSON_AddStringToObject(item, "gpsi",
		                           ext_amf_event_subscription->gpsi) ==
		   NULL)
		{
			printf(
				"ext_amf_event_subscription_convertToJSON() failed [gpsi]");
			goto end;
		}
	}
	...
	if(ext_amf_event_subscription->pei) {
		if(cJSON_AddStringToObject(item, "pei",
		                           ext_amf_event_subscription->pei) ==
		   NULL)
		{
			printf(
				"ext_amf_event_subscription_convertToJSON() failed [pei]");
			goto end;
		}
	}
	...
	if(ext_amf_event_subscription->is_any_ue) {
		if(cJSON_AddBoolToObject(item, "anyUE",
		                         ext_amf_event_subscription->any_ue) ==
		   NULL)
		{
			printf(
				"ext_amf_event_subscription_convertToJSON() failed [any_ue]");
			goto end;
		}
	}
	...
	if(ext_amf_event_subscription->options) {
		cJSON *options_local_JSON = amf_event_mode_convertToJSON(
			ext_amf_event_subscription->options);
		if(options_local_JSON == NULL) {
			printf(
				"ext_amf_event_subscription_convertToJSON() failed [options]");
			goto end;
		}
	...
	if(ext_amf_event_subscription->source_nf_type) {
		cJSON *source_nf_type_local_JSON = nf_type_convertToJSON(
			ext_amf_event_subscription->source_nf_type);
		if(source_nf_type_local_JSON == NULL) {
			printf(
				"ext_amf_event_subscription_convertToJSON() failed [source_nf_type]");
			goto end;
		}
	...
	if(ext_amf_event_subscription->is_term_notify_ind) {
		if(cJSON_AddBoolToObject(item, "termNotifyInd",
		                         ext_amf_event_subscription->
		                         term_notify_ind) == NULL)
		{
			printf(
				"ext_amf_event_subscription_convertToJSON() failed [term_notify_ind]");
			goto end;
		}
	}
	...
	if(ext_amf_event_subscription->binding_info) {
		...
		if(binding_infoList == NULL) {
			printf(
				"ext_amf_event_subscription_convertToJSON() failed [binding_info]");
			goto end;
		}
		list_for_each(ext_amf_event_subscription->binding_info, node) {
	...
	if(ext_amf_event_subscription->subscribing_nf_type) {
		cJSON *subscribing_nf_type_local_JSON = nf_type_convertToJSON(
			ext_amf_event_subscription->subscribing_nf_type);
		if(subscribing_nf_type_local_JSON == NULL) {
			printf(
				"ext_amf_event_subscription_convertToJSON() failed [subscribing_nf_type]");
			goto end;
		}
	...
	if(ext_amf_event_subscription->is_event_sync_ind) {
		...
		{
			printf(
				"ext_amf_event_subscription_convertToJSON() failed [event_sync_ind]");
			goto end;
		}
	}
	...
	if(ext_amf_event_subscription->nf_consumer_info) {
		...
		if(nf_consumer_infoList == NULL) {
			printf(
				"ext_amf_event_subscription_convertToJSON() failed [nf_consumer_info]");
			goto end;
		}
		list_for_each(ext_amf_event_subscription->nf_consumer_info,
		              node) {
	...
	if(ext_amf_event_subscription->aoi_state_list) {
		...
		if(aoi_state_list == NULL) {
			printf(
				"ext_amf_event_subscription_convertToJSON() failed [aoi_state_list]");
			goto end;
		}
		cJSON *localMapObject = aoi_state_list;
		if(ext_amf_event_subscription->aoi_state_list) {
			list_for_each(
				ext_amf_event_subscription->aoi_state_list,
				node) {
				map_t *localKeyValue = (map_t *) node->data;
				...
				if(itemLocal == NULL) {
					printf(
						"ext_amf_event_subscription_convertToJSON() failed [inner]");
					goto end;
				}
	...
	if(ext_amf_event_subscription->access_token) {
		...
		{
			printf(
				"ext_amf_event_subscription_convertToJSON() failed [access_token]");
			goto end;
		}
	}
...
ext_amf_event_subscription_t *ext_amf_event_subscription_parseFromJSON(
	...
	event_list = cJSON_GetObjectItemCaseSensitive(
		ext_amf_event_subscriptionJSON, "eventList");
	if(!event_list) {
		printf(
			"ext_amf_event_subscription_parseFromJSON() failed [event_list]");
		goto end;
	}
	...
	event_notify_uri = cJSON_GetObjectItemCaseSensitive(
		ext_amf_event_subscriptionJSON, "eventNotifyUri");
	if(!event_notify_uri) {
		printf(
			"ext_amf_event_subscription_parseFromJSON() failed [event_notify_uri]");
		goto end;
	}
	...
	notify_correlation_id = cJSON_GetObjectItemCaseSensitive(
		ext_amf_event_subscriptionJSON, "notifyCorrelationId");
	if(!notify_correlation_id) {
		printf(
			"ext_amf_event_subscription_parseFromJSON() failed [notify_correlation_id]");
		goto end;
	}
	...
	nf_id = cJSON_GetObjectItemCaseSensitive(ext_amf_event_subscriptionJSON,
	                                         "nfId");
	if(!nf_id) {
		printf(
			"ext_amf_event_subscription_parseFromJSON() failed [nf_id]");
		goto end;
	}
	...
	subs_change_notify_uri = cJSON_GetObjectItemCaseSensitive(
		ext_amf_event_subscriptionJSON, "subsChangeNotifyUri");
	if(subs_change_notify_uri) {
		if(!cJSON_IsString(subs_change_notify_uri) &&
		   !cJSON_IsNull(subs_change_notify_uri))
		{
			printf(
				"ext_amf_event_subscription_parseFromJSON() failed [subs_change_notify_uri]");
			goto end;
		}
	}
	...
	if(subs_change_notify_correlation_id) {
		...
		{
			printf(
				"ext_amf_event_subscription_parseFromJSON() failed [subs_change_notify_correlation_id]");
			goto end;
		}
	}

	supi = cJSON_GetObjectItemCaseSensitive(ext_amf_event_subscriptionJSON,
	                                        "supi");
	if(supi) {
		...
		{
			printf(
				"ext_amf_event_subscription_parseFromJSON() failed [supi]");
			goto end;
		}
	}

	group_id = cJSON_GetObjectItemCaseSensitive(
		ext_amf_event_subscriptionJSON, "groupId");
	if(group_id) {
		if(!cJSON_IsString(group_id) &&
		   !cJSON_IsNull(group_id))
		{
			printf(
				"ext_amf_event_subscription_parseFromJSON() failed [group_id]");
			goto end;
		}
	}

	exclude_supi_list = cJSON_GetObjectItemCaseSensitive(
		ext_amf_event_subscriptionJSON, "excludeSupiList");
	if(exclude_supi_list) {
		cJSON *exclude_supi_list_local = NULL;
		if(!cJSON_IsArray(exclude_supi_list)) {
			printf(
				"ext_amf_event_subscription_parseFromJSON() failed [exclude_supi_list]");
			goto end;
		}
	...
	exclude_gpsi_list = cJSON_GetObjectItemCaseSensitive(
		ext_amf_event_subscriptionJSON, "excludeGpsiList");
	if(exclude_gpsi_list) {
		cJSON *exclude_gpsi_list_local = NULL;
		if(!cJSON_IsArray(exclude_gpsi_list)) {
			printf(
				"ext_amf_event_subscription_parseFromJSON() failed [exclude_gpsi_list]");
			goto end;
		}
	...
	include_supi_list = cJSON_GetObjectItemCaseSensitive(
		ext_amf_event_subscriptionJSON, "includeSupiList");
	if(include_supi_list) {
		cJSON *include_supi_list_local = NULL;
		if(!cJSON_IsArray(include_supi_list)) {
			printf(
				"ext_amf_event_subscription_parseFromJSON() failed [include_supi_list]");
			goto end;
		}
	...
	include_gpsi_list = cJSON_GetObjectItemCaseSensitive(
		ext_amf_event_subscriptionJSON, "includeGpsiList");
	if(include_gpsi_list) {
		cJSON *include_gpsi_list_local = NULL;
		if(!cJSON_IsArray(include_gpsi_list)) {
			printf(
				"ext_amf_event_subscription_parseFromJSON() failed [include_gpsi_list]");
			goto end;
		}
	...
	gpsi = cJSON_GetObjectItemCaseSensitive(ext_amf_event_subscriptionJSON,
	                                        "gpsi");
	if(gpsi) {
		...
		{
			printf(
				"ext_amf_event_subscription_parseFromJSON() failed [gpsi]");
			goto end;
		}
	}

	pei = cJSON_GetObjectItemCaseSensitive(ext_amf_event_subscriptionJSON,
	                                       "pei");
	if(pei) {
		...
		{
			printf(
				"ext_amf_event_subscription_parseFromJSON() failed [pei]");
			goto end;
		}
	}

	any_ue = cJSON_GetObjectItemCaseSensitive(
		ext_amf_event_subscriptionJSON, "anyUE");
	if(any_ue) {
		if(!cJSON_IsBool(any_ue)) {
			printf(
				"ext_amf_event_subscription_parseFromJSON() failed [any_ue]");
			goto end;
		}
	}

	options = cJSON_GetObjectItemCaseSensitive(
		ext_amf_event_subscriptionJSON, "options");
	if(options) {
	...
	source_nf_type = cJSON_GetObjectItemCaseSensitive(
		ext_amf_event_subscriptionJSON, "sourceNfType");
	if(source_nf_type) {
	...
	term_notify_ind = cJSON_GetObjectItemCaseSensitive(
		ext_amf_event_subscriptionJSON, "termNotifyInd");
	if(term_notify_ind) {
		if(!cJSON_IsBool(term_notify_ind)) {
			printf(
				"ext_amf_event_subscription_parseFromJSON() failed [term_notify_ind]");
			goto end;
		}
	}

	binding_info = cJSON_GetObjectItemCaseSensitive(
		ext_amf_event_subscriptionJSON, "bindingInfo");
	if(binding_info) {
		cJSON *binding_info_local = NULL;
		if(!cJSON_IsArray(binding_info)) {
			printf(
				"ext_amf_event_subscription_parseFromJSON() failed [binding_info]");
			goto end;
		}
	...
	subscribing_nf_type = cJSON_GetObjectItemCaseSensitive(
		ext_amf_event_subscriptionJSON, "subscribingNfType");
	...
	event_sync_ind = cJSON_GetObjectItemCaseSensitive(
		ext_amf_event_subscriptionJSON, "eventSyncInd");
	if(event_sync_ind) {
		if(!cJSON_IsBool(event_sync_ind)) {
			printf(
				"ext_amf_event_subscription_parseFromJSON() failed [event_sync_ind]");
			goto end;
		}
	}

	nf_consumer_info = cJSON_GetObjectItemCaseSensitive(
		ext_amf_event_subscriptionJSON, "nfConsumerInfo");
	if(nf_consumer_info) {
		cJSON *nf_consumer_info_local = NULL;
		if(!cJSON_IsArray(nf_consumer_info)) {
			printf(
				"ext_amf_event_subscription_parseFromJSON() failed [nf_consumer_info]");
			goto end;
		}
	...
	aoi_state_list = cJSON_GetObjectItemCaseSensitive(
		ext_amf_event_subscriptionJSON, "aoiStateList");
	if(aoi_state_list) {
		...
		{
			printf(
				"ext_amf_event_subscription_parseFromJSON() failed [aoi_state_list]");
			goto end;
		}
		if(cJSON_IsObject(aoi_state_list)) {
			...
			cJSON_ArrayForEach(aoi_state_list_local_map,
				...
				if(cJSON_IsObject(localMapObject)) {
					...
					printf(
						"ext_amf_event_subscription_parseFromJSON() failed [inner]");
					goto end;
				}
	...
	access_token = cJSON_GetObjectItemCaseSensitive(
		ext_amf_event_subscriptionJSON, "accessToken");
	if(access_token) {
		if(!cJSON_IsString(access_token) &&
		   !cJSON_IsNull(access_token))
		{
			printf(
				"ext_amf_event_subscription_parseFromJSON() failed [access_token]");
			goto end;
		}
	}

	ext_amf_event_subscription_local_var =
		ext_amf_event_subscription_create(
			event_listList,
			...
			pei &&
			!cJSON_IsNull(pei) ? strdup(
				pei->valuestring) : NULL,
			any_ue ? true : false,
...
ext_amf_event_subscription_t *ext_amf_event_subscription_copy(
	...
	item = ext_amf_event_subscription_convertToJSON(src);
	if(!item) {
		printf("ext_amf_event_subscription_convertToJSON() failed");
		return NULL;
	}
	...
	ext_amf_event_subscription_free(dst);
	dst = ext_amf_event_subscription_parseFromJSON(item);
	cJSON_Delete(item);
