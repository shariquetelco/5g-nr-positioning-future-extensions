...
char *integrity_algorithm_ToString(integrity_algorithm_e integrity_algorithm) {
	const char *integrity_algorithmArray[] =
	{ "NULL", "NIA0", "NIA1", "NIA2", "NIA3" };
	size_t sizeofArray = sizeof(integrity_algorithmArray) /
	                     sizeof(integrity_algorithmArray[0]);
...
integrity_algorithm_e integrity_algorithm_FromString(char *integrity_algorithm)
{
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(integrity_algorithm,
		          integrity_algorithmArray[stringToReturn]) == 0) {
