...
------------ | ------------- | ------------- | -------------
**up_notify_call_back_uri** | **char \*** | String providing an URI formatted according to RFC 3986. | 
...
**amf_reallocation_ind** | **int** |  | [optional] [default to false]
**lcs_up_connection_ind** | **lcs_up_connection_ind_t \*** |  | [optional] 
