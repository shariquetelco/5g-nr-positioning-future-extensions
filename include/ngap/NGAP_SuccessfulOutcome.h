...
typedef struct NGAP_SuccessfulOutcome {
	...
	struct NGAP_SuccessfulOutcome__value {
		...
		union NGAP_SuccessfulOutcome__NGAP_value_u {
			...
			NGAP_BroadcastSessionTransportResponse_t	 BroadcastSessionTransportResponse;
			...
			NGAP_MTCommunicationHandlingResponse_t	 MTCommunicationHandlingResponse;
			...
			NGAP_TimingSynchronisationStatusResponse_t	 TimingSynchronisationStatusResponse;
