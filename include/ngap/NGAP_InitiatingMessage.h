...
typedef struct NGAP_InitiatingMessage {
	...
	struct NGAP_InitiatingMessage__value {
		...
		union NGAP_InitiatingMessage__NGAP_value_u {
			...
			NGAP_BroadcastSessionTransportRequest_t	 BroadcastSessionTransportRequest;
			...
			NGAP_MTCommunicationHandlingRequest_t	 MTCommunicationHandlingRequest;
			...
			NGAP_TimingSynchronisationStatusRequest_t	 TimingSynchronisationStatusRequest;
			...
			NGAP_RANPagingRequest_t	 RANPagingRequest;
			...
			NGAP_TimingSynchronisationStatusReport_t	 TimingSynchronisationStatusReport;
