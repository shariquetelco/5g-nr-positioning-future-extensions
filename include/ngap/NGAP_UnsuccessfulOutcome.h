...
typedef struct NGAP_UnsuccessfulOutcome {
	...
	struct NGAP_UnsuccessfulOutcome__value {
		...
		union NGAP_UnsuccessfulOutcome__NGAP_value_u {
			...
			NGAP_BroadcastSessionTransportFailure_t	 BroadcastSessionTransportFailure;
			...
			NGAP_MTCommunicationHandlingFailure_t	 MTCommunicationHandlingFailure;
			...
			NGAP_TimingSynchronisationStatusFailure_t	 TimingSynchronisationStatusFailure;
