...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_NRPPa_pCI_NR_constr_5 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_NRPPa_SRSCarrier_List_Item_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct NRPPa_SRSCarrier_List_Item, pCI_NR),
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_NRPPa_pCI_NR_constr_5,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
	...
	{ ATF_POINTER, 1, offsetof(struct NRPPa_SRSCarrier_List_Item, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NRPPa_ProtocolExtensionContainer_4443P118,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
