...
asn_TYPE_member_t asn_MBR_NRPPa_PosSRSResourceSet_Item_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NRPPa_PosSRSResourceSet_Item, possRSResourceIDPerSet_List),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NRPPa_PosSRSResourceIDPerSet_List,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_POINTER, 1, offsetof(struct NRPPa_PosSRSResourceSet_Item, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NRPPa_ProtocolExtensionContainer_4443P49,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
