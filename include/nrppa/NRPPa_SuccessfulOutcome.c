...
static asn_TYPE_member_t asn_MBR_NRPPa_value_5[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NRPPa_SuccessfulOutcome__value, choice.PRSConfigurationResponse),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_NRPPa_PRSConfigurationResponse,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NRPPa_SuccessfulOutcome__value, choice.MeasurementPreconfigurationConfirm),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_NRPPa_MeasurementPreconfigurationConfirm,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
