...
static int
memb_NRPPa_lCS_to_GCS_TranslationList_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	size_t size;
...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_NRPPa_lCS_to_GCS_TranslationList_constr_4 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_NRPPa_lCS_to_GCS_TranslationList_constr_4 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 2,  2,  1,  3 }	/* (SIZE(1..3)) */,
	0, 0	/* No PER value map */
};
...
static asn_TYPE_member_t asn_MBR_NRPPa_lCS_to_GCS_TranslationList_4[] = {
	{ ATF_POINTER, 0, 0,
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_NRPPa_LCS_to_GCS_TranslationItem,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const ber_tlv_tag_t asn_DEF_NRPPa_lCS_to_GCS_TranslationList_tags_4[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SET_OF_specifics_t asn_SPC_NRPPa_lCS_to_GCS_TranslationList_specs_4 = {
	sizeof(struct NRPPa_NR_PRS_Beam_Information__lCS_to_GCS_TranslationList),
	offsetof(struct NRPPa_NR_PRS_Beam_Information__lCS_to_GCS_TranslationList, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_NRPPa_lCS_to_GCS_TranslationList_4 = {
	"lCS-to-GCS-TranslationList",
	"lCS-to-GCS-TranslationList",
	&asn_OP_SEQUENCE_OF,
	asn_DEF_NRPPa_lCS_to_GCS_TranslationList_tags_4,
	sizeof(asn_DEF_NRPPa_lCS_to_GCS_TranslationList_tags_4)
		/sizeof(asn_DEF_NRPPa_lCS_to_GCS_TranslationList_tags_4[0]) - 1, /* 1 */
	asn_DEF_NRPPa_lCS_to_GCS_TranslationList_tags_4,	/* Same as above */
	sizeof(asn_DEF_NRPPa_lCS_to_GCS_TranslationList_tags_4)
		/sizeof(asn_DEF_NRPPa_lCS_to_GCS_TranslationList_tags_4[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_NRPPa_lCS_to_GCS_TranslationList_constr_4,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		SEQUENCE_OF_constraint
	},
	asn_MBR_NRPPa_lCS_to_GCS_TranslationList_4,
	1,	/* Single element */
	&asn_SPC_NRPPa_lCS_to_GCS_TranslationList_specs_4	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_NRPPa_NR_PRS_Beam_Information_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct NRPPa_NR_PRS_Beam_Information, lCS_to_GCS_TranslationList),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_NRPPa_lCS_to_GCS_TranslationList_4,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_NRPPa_lCS_to_GCS_TranslationList_constr_4,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
			memb_NRPPa_lCS_to_GCS_TranslationList_constraint_1
		},
		0, 0, /* No default value */
		"lCS-to-GCS-TranslationList"
		},
	{ ATF_POINTER, 1, offsetof(struct NRPPa_NR_PRS_Beam_Information, iE_Extensions),
		...
		&asn_DEF_NRPPa_ProtocolExtensionContainer_4443P40,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_NRPPa_NR_PRS_Beam_Information_oms_1[] = { 1, 2 };
